...
public class ZKClient {
    ...
    public void getDispatcherZKPath(String ipPort, final String zkPath, ConcurrentSkipListSet<String> serverList){
        try {
           ...
           LOG.error("ZKClient getDispatcherZKPath error exception",e);
        }
    }
    ...
    public static void main(String[] args) {
        ...
        initZkClient(IP_PORT,countDownLatch);
        try {
            countDownLatch.await();
        } catch (Exception e) {
        ...
        getChildrenPath(ROOT_PATH,serverList);
    }
